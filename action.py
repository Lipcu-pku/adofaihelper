...
class ACTION:
    ...
    def load(cls, floor: int | None = None, eventType: str | EventTypes | None = None, **kwargs):
        ...
        eventType = eventTypes(kwargs['eventType'])
        match eventType:
    ...
    class SetSpeed:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.speedType = SpeedType(kwargs.get('speedType', SpeedType.Bpm))
            """速度类型"""
            self.beatsPerMinute = Value(kwargs.get('beatsPerMinute', 100))
            """BPM"""
            self.bpmMultiplier = Value(kwargs.get('bpmMultiplier', 1))
            """倍频"""
            self.angleOffset = Value(kwargs.get('angleOffset', 0))
            """角度偏移"""
    ...
    class SetHitsound:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.gameSound = GameSound(kwargs.get('gameSound', GameSound.Hitsound))
            """打拍音设置目标"""
    ...
    class SetPlanetRotation:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.ease = EASE(kwargs.get('ease', EASE.Linear))
            """缓速"""
            self.easeParts = int(kwargs.get('waseParts', 1))
            """缓速部分"""
            self.easePartBehavior = EASE_PART_BEHAVIOR(kwargs.get('easePartBehavior', EASE_PART_BEHAVIOR.Mirror))
            """缓速部分行为"""
    @get_value
    class Pause:
        """暂停节拍"""
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.duration = Value(kwargs.get('duration', 1))
            """暂停时长（拍）"""
            ...
            self.angleCorrectionDir = int(_angleCorrectionDir[kwargs.get('angleCorrectionDir', "Backward")])
            """角度校正（-1, 0, 1）[2.8.5 Alpha已更新为Backward/None/Forward]"""
    ...
    class AutoPlayTiles:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.enabled = boolean(kwargs.get('enabled', True))
            """设置为"""
            self.showStatusText = boolean(kwargs.get('showStatusText', True))
            """显示“自动方块”文本"""
            self.safetyTiles = boolean(kwargs.get('safetyTiles', False))
            """保险方块 [关卡编辑器中不可直接编辑]"""
    ...
    class ScalePlanets:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.duration = Value(kwargs.get('duration'))
            """时长"""
            self.targetPlanet = Planet(kwargs.get('targetPlanet', Planet.FirePlanet))
            """目标星球"""
            self.scale = Value(kwargs.get('scale', 100))
            """星球大小"""
            self.angleOffset = Value(kwargs.get('angleOffset', 0))
            """角度偏移"""
            self.ease = EASE(kwargs.get('ease', EASE.Linear))
    ...
    class ColorTrack:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            if 'floorIconOutlines' in kwargs:
                ...
                """方块图标描边 [可隐藏]"""
            self.justThisTile = boolean(kwargs.get('justThisTile', False))
            """仅改变此方块"""
    ...
    class RecolorTrack:
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.startTile = Data_Pair.TilePosition.from_int_str(kwargs.get('startTile', (0, 'Start')))
            """效果起始方块"""
            self.endTile = Data_Pair.TilePosition.from_int_str(kwargs.get('endTile', (0, 'End')))
            """效果结束方块"""
            self.gapLength = int(kwargs.get('gapLength', 0))
            """间隙长度"""
            self.duration = Value(kwargs.get('duration', 0))
            """时长"""
            self.trackColorType = TRACK_COLOR_TYPE(kwargs.get('trackColorType', TRACK_COLOR_TYPE.Single))
            """轨道颜色类型"""
            self.trackColor = Color(kwargs.get('trackColor', 'debb7b'))
    ...
    class MoveTrack:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.startTile = Data_Pair.TilePosition.from_int_str(kwargs.get('startTile', (0, 'ThisTile')))
            """效果起始方块"""
            self.endTile = Data_Pair.TilePosition.from_int_str(kwargs.get('endTile', (0, 'ThisTile')))
            """效果结束方块"""
            self.gapLength = int(kwargs.get('gapLength', 0))
            """间隙长度"""
            self.duration = Value(kwargs.get('duration', 1))
            ...
            if 'positionOffset' in kwargs:
                self.positionOffset = Data_Pair.XY_NonePair.from_tuple(kwargs.get('positionOffset', (None, None)))
                """位置偏移"""
            if 'rotationOffset' in kwargs:
                self.rotationOffset = Value(kwargs.get('rotationOffset', 0))
                """旋转偏移"""
            if 'scale' in kwargs:
                self.scale = Data_Pair.XY_NonePair.from_tuple(kwargs.get('scale', (None, None)))
                """缩放"""
            if 'opacity' in kwargs:
                self.opacity = Value(kwargs.get('opacity', 100))
                """透明度"""
            self.angleOffset = Value(kwargs.get('angleOffset', 0))
            """角度偏移"""
            self.ease = EASE(kwargs.get('ease', EASE.Linear))
            """缓速"""
            self.maxVfxOnly = boolean(kwargs.get('maxVfxOnly', False))
    ...
    class PositionTrack:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            if 'positionOffset' in kwargs:
                self.positionOffset = Data_Pair.XY_Pair.from_tuple(kwargs.get('positionOffset', (0, 0)))
                """位置偏移"""
            self.relativeTo = Data_Pair.TilePosition.from_int_str(kwargs.get('relativeTo', [0, 'ThisTile']))
            """相对于"""
            ...
            self.justThisTile = boolean(kwargs.get('justThisTile', False))
            """仅改变此方块"""
            self.editorOnly = boolean(kwargs.get('editorOnly', False))
            """仅限编辑器"""
    ...
    class MoveDecorations:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            if 'visible' in kwargs:
                self.visible = boolean(kwargs.get('visible', True))
                """可见"""
            if 'relativeTo' in kwargs:
                self.relativeTo = DecorationRelative(kwargs.get('relativeTo', DecorationRelative.Tile))
                """相对于"""
            ...
            if 'pivotOffset' in kwargs:
                self.pivotOffset = Data_Pair.XY_NonePair.from_tuple(kwargs.get('pivotOffset', (None, None)))
                """轴心偏移"""
            if 'rotationOffset' in kwargs:
                self.rotationOffset = Value(kwargs.get('rotationOffset', 0))
                """旋转偏移"""
            ...
            if 'parallaxOffset' in kwargs:
                self.parallaxOffset = Data_Pair.XY_NonePair.from_tuple(kwargs.get('parallaxOffset', [None, None]))
                """视差偏移"""
            self.angleOffset = Value(kwargs.get('angleOffset', 0))
            """角度偏移"""
            self.ease = EASE(kwargs.get('ease', EASE.Linear))
    ...
    class SetParticle:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            if 'targetMode' in kwargs:
                self.targetMode = ParticleMode(kwargs.get('targetMode', ParticleMode.Start))
                """模式"""
            self.eventTag = str(kwargs.get('eventTag', ''))
            """事件标签"""
            ...
            if 'simulationSpeed' in kwargs:
                self.simulationSpeed = Value(kwargs.get('simulationSpeed', 100))
                """模拟速度"""
            self.angleOffset = Value(kwargs.get('angleOffset', 0))
            if 'lockRotation' in kwargs:
                self.lockRotation = boolean('lockRotation', False)
                """锁定转角"""
            if 'lockScale' in kwargs:
                self.lockScale = boolean('lockScale', False)
                """锁定大小"""
            self.ease = EASE(kwargs.get('ease', EASE.Linear))
            ...
            if 'shapeType' in kwargs:
                self.shapeType = value_to_enum(ParticleShapeType, kwargs.get('shapeType'))
                """粒子发射形状"""
                if self.shapeType == ParticleShapeType.Circle:
                    if 'shapeRadius' in kwargs:
                        self.shapeRadius = Value(kwargs.get('shapeRadius', 1))
                        """半径"""
                    if 'arc' in kwargs:
                        self.arc = Value(kwargs.get('arc', 360))
                        """弧"""
            ...
            if 'colorOverLifetime' in kwargs:
                self.colorOverLifetime = ParticleColor(**kwargs['colorOverLifetime'])
                """随时间变色"""
            if 'sizeOverLifetime' in kwargs:
                self.sizeOverLifetime = Data_Pair.Range_Pair.from_tuple(kwargs.get('sizeOverLifetime', (100, 100)))
                """随时间缩放"""
            if 'velocity' in kwargs:
                self.velocity = Data_Pair.Increasing_Range_Pair.from_tuple(kwargs.get('velocity', ((0, 0, (0, 0)))))
                """随时间变速"""
    ...
    class SetObject:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            if 'trackAngle' in kwargs:
                self.trackAngle = Value(kwargs.get('trackAngle', 180))
                """轨道角度"""
            ...
            if 'trackOpacity' in kwargs:
                self.trackOpacity = Value(kwargs.get('trackOpacity', 100))
                """透明度"""
            ...
            if 'trackIconAngle' in kwargs:
                self.trackIconAngle = Value(kwargs.get('trackIconAngle', 0))
                """轨道图标角度"""
            ...
            if 'trackGlowEnabled' in kwargs:
                self.trackGlowEnabled = boolean(kwargs.get('trackGlowEnabled', False))
                """允许轨道发光"""
    ...
    class SetDefaultText:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            if 'levelTitlePosition' in kwargs:
                self.levelTitlePosition = Data_Pair.XY_Pair.from_tuple(kwargs.get('levelTitlePosition', (0, 0)))
                """关卡标题位置"""
    ...
    class CustomBackground:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """背景图片（相对文件路径）"""
            self.imageColor = Color(kwargs.get('imageColor', 'ffffff'))
            """图片颜色"""
    ...
    class Flash:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            self.duration = Value(kwargs.get('duration', 1))
            """时长"""
            self.plane = Plane(kwargs.get('plane', Plane.Background))
            """平面"""
            self.startColor = Color(kwargs.get('startColor', 'ffffff'))
            """起始颜色"""
            self.startOpacity = Value(kwargs.get('startOpacity', 100))
            """起始透明度"""
            self.endColor = Color(kwargs.get('endColor', 'ffffff'))
            """结束颜色"""
            self.endOpacity = Value(kwargs.get('endOpacity', 0))
            """结束透明度"""
            self.angleOffset = Value(kwargs.get('angleOffset', 0))
            """角度偏移"""
            self.ease = EASE(kwargs.get('ease', EASE.Linear))
    ...
    class MoveCamera:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            if 'position' in kwargs:
                self.position = Data_Pair.XY_NonePair.from_tuple(kwargs.get('position', (None, None)))
                """位置"""
            if 'rotation' in kwargs:
                self.rotation = Value(kwargs.get('rotation', 0))
                """角度"""
            ...
            self.ease = EASE(kwargs.get('ease', EASE.Linear))
            """缓速"""
            self.dontDisable = boolean(kwargs.get('dontDisable', False))
            """不禁用 [关卡编辑器中不可直接编辑]"""
            self.minVfxOnly = boolean(kwargs.get('minVfxOnly', False))
            """仅限低视效 [关卡编辑器中不可直接编辑]"""
            self.eventTag = str(kwargs.get('eventTag', ''))
            """事件标签"""
    ...
    class SetFilter:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.filter = Filter(kwargs.get('filter', Filter.Grayscale))
            """滤镜"""
            self.enabled = boolean(kwargs.get('enabled', True))
            """启用"""
            self.intensity = Value(kwargs.get('intensity', 100))
            """强度"""
            self.duration = Value(kwargs.get('duration', 0))
            """时长"""
            self.ease = EASE(kwargs.get('ease', EASE.Linear))
            """缓速"""
            self.disableOthers = boolean(kwargs.get('disableOthers', False))
            """禁用其它"""
            self.angleOffset = Value(kwargs.get('angleOffset', 0))
            """角度偏移"""
            self.eventTag = str(kwargs.get('eventTag', ''))
    ...
    class SetFilterAdvanced:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.filter = AdvancedFilterName(kwargs.get('filter', AdvancedFilterName.AAA_SuperComputer))
            """滤镜"""
            self.enabled = boolean(kwargs.get('enabled', True))
            """启用"""
            self.disabledOthers = boolean(kwargs.get('disabledOthers', False))
            """禁用其它"""
            self.duration = Value(kwargs.get('duration', 0))
            """时长"""
            self.ease = EASE(kwargs.get('ease', EASE.Linear))
            """缓速"""
            self.targetType = AdvancedFilterTartgetType(kwargs.get('targetType', AdvancedFilterTartgetType.Decoration))
            """目标类型 [关卡编辑器中不可直接编辑]"""
            self.plane = Plane(kwargs.get('plane', Plane.Foreground))
            """平面"""
    ...
    class ShakeScreen:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            self.duration = Value(kwargs.get('duration', 1))
            """时长"""
            self.strength = Value(kwargs.get('strength', 100))
            """力度"""
            self.intensity = Value(kwargs.get('intensity', 100))
            """速度"""
            self.ease = EASE(kwargs.get('ease', EASE.Linear))
            """缓速"""
            self.fadeOut = boolean(kwargs.get('fadeOut', True))
            """淡出"""
            self.angleOffset = Value(kwargs.get('angleOffset', 0))
            """角度偏移"""
            self.eventTag = str(kwargs.get('eventTag', ''))
    ...
    class Bloom:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            self.enabled = boolean(kwargs.get('enabled', True))
            """启用"""
            self.threshold = Value(kwargs.get('threshold', 50))
            """阈值"""
            self.intensity = Value(kwargs.get('intensity', 100))
            """强度"""
            self.color = str(kwargs.get('color', 'ffffff'))
    ...
    class ScreenTile:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            self.duration = Value(kwargs.get('duration', 0))
            """时长"""
            self.tile = Data_Pair.XY_Pair.from_tuple(kwargs.get('tile', (1, 1)))
            """平铺"""
            self.angleOffset = Value(kwargs.get('angleOffset', 0))
            """角度偏移"""
            self.ease = EASE(kwargs.get('ease', EASE.Linear))
    ...
    class ScreenScroll:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.scroll = Data_Pair.XY_Pair.from_tuple(kwargs.get('scroll', (0, 0)))
            """卷屏速度"""
            self.angleOffset = Value(kwargs.get('angleOffset', 0))
            """角度偏移"""
            self.eventTag = str(kwargs.get('eventTag', ''))
    ...
    class SetFrameRate:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            self.enabled = boolean(kwargs.get('enabled', True))
            """启用"""
            self.frameRate = Value(kwargs.get('frameRate', 5))
            """帧率"""
            self.angleOffset = Value(kwargs.get('angleOffset', 0))
            """角度偏移"""
    ...
    class RepeatEvents:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.repeatType = RepeatType(kwargs.get('repeatType', RepeatType.Beat))
            """重复类型"""
            self.repetitions = int(kwargs.get('repetitions', 1))
            """重复次数"""
            self.floorCount = int(kwargs.get('floorCount', 1))
            """重复方块数"""
            self.interval = Value(kwargs.get('interval', 1))
            """间隔时长"""
            self.executeOnCurrentFloor = boolean(kwargs.get('executeOnCurrentFloor', False))
            """在当前方块执行"""
            self.tag = str(kwargs.get('tag', ''))
            """目标标签"""
    ...
    class SetInputEvent:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            self.floor = int(floor)
            """事件所在砖块"""
            self.eventType = eventTypes.Modifiers.SetInputEvent
            """事件类型"""
            self.target = InputEventTarget(kwargs.get('target', 'Any'))
            """检测对象"""
            self.state = InputEventState(kwargs.get('state', 'Down'))
            """检测对象状态"""
            self.ignoreInput = boolean(kwargs.get('ignoreInput', False))
            """无视输入"""
            self.targetEventTag = str(kwargs.get('targetEventTag', 'NONE'))
            """目标事件标签"""
            self.angleOffset = int(kwargs.get('angleOffset', 0))
            """角度偏移"""
            self.eventTag = str(kwargs.get('eventTag', ''))
            """事件标签"""
    ...
    class Hold:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """旅行距离（%）"""
            self.landingAnimation = boolean(kwargs.get('landingAnimation', False))
            """收尾动画"""
    ...
    class SetHoldSound: 
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.holdStartSound = value_to_enum(HoldSound, kwargs.get('holdStartSound', HoldSound.Fuse), HoldSound.SingSing)
            """长按开始音效"""
            self.holdLoopSound = value_to_enum(HoldSound, kwargs.get('holdLoopSound', HoldSound.Fuse), HoldSound.SingSing)
            """长按循环音效"""
            self.holdEndSound = value_to_enum(HoldSound, kwargs.get('holdEndSound', HoldSound.Fuse), HoldSound.SingSing)
            """长按结束音效"""
            self.holdMidSound = HoldSound(kwargs.get('holdMidSound', HoldSound.Fuse))
            """长按中段音效"""
            self.holdMidSoundType = HoldMidSoundType(kwargs.get('holdMidSoundType', HoldMidSoundType.Once))
            """长按中段音效类型"""
            self.holdMidSoundDelay = Value(kwargs.get('holdMidSoundDelay', 0.5))
            """长按中段音效延迟"""
            self.holdMidSoundTimingRelativeTo = HoldMidSoundTimingRelative(kwargs.get('holdMidSoundTimingRelativeTo', HoldMidSoundTimingRelative.End))
            """长按中段音效延迟关联到"""
    ...
    class MultiPlanet:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.planets = MultiPlanets(kwargs.get('planets', MultiPlanets.TwoPlanets))
            """行星数"""
    ...
    class FreeRoam:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """时长"""
            self.size = Data_Pair.XY_natural_Pair.from_tuple(kwargs.get('size', (4, 4)))
            """自由区域大小"""
            self.positionOffset = Data_Pair.XY_Pair.from_tuple(kwargs.get('positionOffset', (0, 0)))
            """位置偏移"""
            self.outTime = int(kwargs.get('outTime', 4))
            """退出过渡时长"""
            self.outEase = EASE(kwargs.get('ease', EASE.Linear))
            """缓速"""
            self.hitsoundOnBeats = HITSOUND(kwargs.get('hitsoundOnBeats', HITSOUND.NONE))
            """强拍击拍音效"""
            self.hitsoundOffBeats = HITSOUND(kwargs.get('hitsoundOffBeats', HITSOUND.NONE))
            """弱拍击拍音效"""
    ...
    class FreeRoamTwirl:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.position = Data_Pair.XY_natural_Pair.from_tuple(kwargs.get('position', (1, 0)))
            """位置偏移"""
    ...
    class FreeRoamRemove:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            self.position = Data_Pair.XY_natural_Pair.from_tuple(kwargs.get('position', (1, 0)))
            """位置偏移"""
            self.size = Data_Pair.XY_natural_Pair.from_tuple(kwargs.get('size', (1, 1)))
            """要移除的区域大小"""
    ...
    class Hide:
        ...
        def __init__(self, floor: int | None = None, **kwargs) -> None:
            ...
            """事件类型"""
            self.hideJudgment = boolean(kwargs.get('hideJudgment', False))
            """隐藏判定文本"""
            self.hideTileIcon = boolean(kwargs.get('hideTileIcon', False))
            """隐藏方块图标"""
